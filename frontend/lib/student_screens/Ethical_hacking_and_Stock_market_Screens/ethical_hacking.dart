...
class EthicalHackingScreen extends StatefulWidget {
  const EthicalHackingScreen({super.key});

  @override
  State<EthicalHackingScreen> createState() => _EthicalHackingScreenState();
}

class _EthicalHackingScreenState extends State<EthicalHackingScreen> {
  late CustomVideoPlayerController _customVideoPlayerController;
  late CachedVideoPlayerController _cachedVideoPlayerController;
  int _currentVideoIndex = 0;
  final List<bool> _isPlayingList = [];

  final List<Video> _videos = List.generate(86, (index) => Video(
    title: 'Video ${index + 1}',
    url: '${ApiEndpoints.hackingVideos}/v${index + 1}.mp4',
  ));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Ethical Hacking ', style: TextStyle(fontFamily: "MainFont", color: Colors.white)),
        backgroundColor: Colors.blueAccent,
      ),
      body: Column(
        children: [
