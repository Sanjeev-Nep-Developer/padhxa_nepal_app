...
class _ChemistryScreenState extends State<ChemistryScreen> {
  ...
  final List<Video> _videos = List.generate(14, (index) => Video(
    title: 'Video ${index + 1}',
    url: '${ApiEndpoints.chemistryVideos}/v${index + 1}.mp4',
  ));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Chemistry Videos', style: TextStyle(fontFamily: "MainFont", color: Colors.white)),
        backgroundColor: Colors.blueAccent,
      ),
      body: Column(
        children: [
