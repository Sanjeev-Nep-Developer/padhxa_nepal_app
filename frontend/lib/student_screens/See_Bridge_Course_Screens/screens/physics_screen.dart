...
class _PhysicsScreenState extends State<PhysicsScreen> {
  ...
  final List<Video> _videos = List.generate(25, (index) => Video(
    title: 'Video ${index + 1}',
    url: '${ApiEndpoints.physicsVideo}/v${index + 1}.mp4',
  ));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Physics Videos', style: TextStyle(fontFamily: "MainFont", color: Colors.white)),
        backgroundColor: Colors.blueAccent,
      ),
      body: Column(
        children: [
