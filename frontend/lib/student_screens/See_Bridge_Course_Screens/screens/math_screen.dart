...
class _MathScreenState extends State<MathScreen> {
  ...
  final List<Video> _videos = List.generate(18, (index) => Video(
    title: 'Video ${index + 1}',
    url: '${ApiEndpoints.mathVideos}/v${index + 1}.mp4',
  ));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Math Videos', style: TextStyle(fontFamily: "MainFont", color: Colors.white)),
        backgroundColor: Colors.blueAccent,
      ),
      body: Column(
        children: [
