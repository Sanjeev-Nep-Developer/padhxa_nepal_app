...
class _EnglishScreenState extends State<EnglishScreen> {
  ...
  final List<Video> _videos = List.generate(13, (index) => Video(
    title: 'Video ${index + 1}',
    url: '${ApiEndpoints.englishVideos}/v${index + 1}.mp4',
  ));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('English Videos', style: TextStyle(fontFamily: "MainFont", color: Colors.white)),
        backgroundColor: Colors.blueAccent,
      ),
      body: Column(
        children: [
