...
class _BiologyScreenState extends State<BiologyScreen> {
  ...
  final List<Video> _videos = List.generate(20, (index) => Video(
    title: 'Video ${index + 1}',
    url: '${ApiEndpoints.bilogyVidoes}/v${index + 1}.mp4',
  ));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Biology Videos', style: TextStyle(fontFamily: "MainFont", color: Colors.white)),
        backgroundColor: Colors.blueAccent,
      ),
      body: Column(
        children: [
