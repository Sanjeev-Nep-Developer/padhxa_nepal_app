...
void main() {
  runApp(MaterialApp(home: CantHurtMe()));
}

class CantHurtMe extends StatefulWidget {
  @override
  _CantHurtMeState createState() => _CantHurtMeState();
}

class _CantHurtMeState extends State<CantHurtMe> {
  final List<String> titles = [
    "Dont give up",
    "Tough Times",
    "mental health is important",
    "Quitting is not a solution",
    "become a dimond under",
    "take challenges",
    "hard work wins",
  ];
  ...
  static const String folderPath = '7_cant_hurt_me';
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => AudioPlayerScreen(
          title: titles[index],
          audioPath: '$baseUrl$folderPath/CH${index + 1}.mp3',
        ...
        children: [
          Container(
            ...
            child: Column(
              ...
              children: [
                SizedBox(height: 5),
                Image.asset("assets/images/i7.png", width: 360, height: 310),
                SizedBox(height: 15),
                Text(
                  ' Cant Hurt Me ',
                  style: TextStyle(
