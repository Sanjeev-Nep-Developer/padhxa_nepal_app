...
void main() {
  runApp(MaterialApp(home: PsychologyOfMoney()));
}

class PsychologyOfMoney extends StatefulWidget {
  @override
  _PsychologyOfMoneyState createState() => _PsychologyOfMoneyState();
}

class _PsychologyOfMoneyState extends State<PsychologyOfMoney> {
  final List<String> titles = [
    ...
    " nothing is free",
    " reasonablerational surprise",
    " room for error",
    "tou and me",
    " when you will believe in anything",
    " all together now confession"
  ];
  ...
  static const String folderPath = '8_psychology_money';
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => AudioPlayerScreen(
          title: titles[index],
          audioPath: '$baseUrl$folderPath/PM${index + 1}.mp3',
        ...
        children: [
          Container(
            ...
            child: Column(
              ...
              children: [
                SizedBox(height: 5),
                Image.asset("assets/images/i2.png", width: 360, height: 310),
                SizedBox(height: 15),
                Text(
                  'Psychology Of Money',
                  style: TextStyle(
