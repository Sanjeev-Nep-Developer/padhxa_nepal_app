...
void main() {
  runApp(MaterialApp(home: BrainOnPorn()));
}

class BrainOnPorn extends StatefulWidget {
  @override
  _BrainOnPornState createState() => _BrainOnPornState();
}

class _BrainOnPornState extends State<BrainOnPorn> {
  final List<String> titles = [
    " Porn Addiction",
    " Pornography and Your Brain",
    " Pornography can Trigger Your Dopamine",
    "Porn addiction Ka Solution",
    "Summary",
  ];
  ...
  static const String folderPath = '15_your_brain_on_porn';
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => AudioPlayerScreen(
          ...
          imagePath: 'assets/images/i15.png',
        ),
      ),
    );
  }
        ...
        children: [
          Container(
            ...
            child: Column(
              ...
              children: [
                SizedBox(height: 5),
                Image.asset("assets/images/i15.png", width: 360, height: 310),
                SizedBox(height: 15),
                Text(
                  'Brain ON Porn ',
                  style: TextStyle(
