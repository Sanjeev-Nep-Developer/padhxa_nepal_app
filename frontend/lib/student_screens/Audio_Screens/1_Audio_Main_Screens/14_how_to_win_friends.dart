...
void main() {
  runApp(MaterialApp(home: HowToWinFriends()));
}

class HowToWinFriends extends StatefulWidget {
  @override
  _HowToWinFriendsState createState() => _HowToWinFriendsState();
}

class _HowToWinFriendsState extends State<HowToWinFriends> {
  ...
  static const String folderPath = '11_how_to_win_friends';
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => AudioPlayerScreen(
          ...
          imagePath: 'assets/images/i14.png',
        ),
      ),
    );
  }
        ...
        children: [
          Container(
            ...
            child: Column(
              ...
              children: [
                SizedBox(height: 5),
                Image.asset("assets/images/i14.png", width: 360, height: 310),
                SizedBox(height: 15),
                Text(
                  'How To Win Friends and Influence People ',
